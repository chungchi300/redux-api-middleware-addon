...
function network() {
  ...
  switch (true) {
    case action.type == 'SUCCESS':
      ...
      return _extends({}, state, defineProperty({}, action.meta.name, 'SUCCESS'));

    case action.type == 'FAILURE':
      return _extends({}, state, defineProperty({}, action.meta.name, 'FAILURE'));

    case action.type == 'REQUEST':
      return _extends({}, state, defineProperty({}, action.meta.name, 'REQUEST'));
  }
  return state;
}
