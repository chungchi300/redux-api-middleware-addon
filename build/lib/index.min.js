...
var stringify$2 = function stringify$$1(it) { // eslint-disable-line no-unused-vars
...
function formData(dataMap, contentType) {
  ...
  if (contentType === 'multipart/form-data') {
    ...
    _Object$keys(dataMap).forEach(function (key) {
    ...
    return _JSON$stringify(dataMap);
  } else {
...
function subsituteUrl(url, substitues) {
  ...
  _Object$keys(substitues).forEach(function (key, index) {
...
function request(pathName, _ref, types) {
  ...
  return function () {
    var _ref2 = _asyncToGenerator(index.mark(function _callee(dispatch, getState) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              headers = _extends$1({}, getState().api.headers, pathEntity.headers);
              body = void 0;
...
function api() {
  ...
  switch (action.type) {
    case 'API:SET_BASE_HEADERS':
      return _extends$1({}, state, { headers: action.payload.headers });
    case 'API:SET_SWAGGER':
      return _extends$1({}, state, action.payload);
    case 'API:SET_PROTOCOL':
      return _extends$1({}, state, { protocol: action.payload });
  }
  return state;
}
...
function network() {
  ...
  switch (true) {
    case action.type == 'SUCCESS':
      return _extends$1({}, state, _defineProperty({}, action.meta.source, 'SUCCESS'));

    case action.type == 'FAILURE':
      return _extends$1({}, state, _defineProperty({}, action.meta.source, 'FAILURE'));

    case action.type == 'REQUEST':
      return _extends$1({}, state, _defineProperty({}, action.meta.source, 'REQUEST'));
  }
  return state;
}
...
function domain() {
  ...
  switch (true) {
    case idsRegexResult != null:
      ...
      return _extends$1({}, state, newObjectWithIds);
  }
  return state;
}
