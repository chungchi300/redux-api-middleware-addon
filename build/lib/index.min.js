            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  _context.next = 11;
                  return dispatch(
                    _defineProperty({}, reduxApiMiddleware.CALL_API, result)
                  );
...
function api() {
  var state =
    arguments.length > 0 && arguments[0] !== undefined
      ? arguments[0]
      : { protocol: 'http', contentType: '', headers: {} };
  ...
  switch (true) {
    case action.type == 'SUCCESS':
      ...
      return _extends$4(
        {},
        state,
        _defineProperty$1({}, action.meta.name, 'SUCCESS')
      );
    ...
    case action.type == 'FAILURE':
      return _extends$4(
        {},
        state,
        _defineProperty$1({}, action.meta.name, 'FAILURE')
      );
    ...
    case action.type == 'REQUEST':
      return _extends$4(
        {},
        state,
        _defineProperty$1({}, action.meta.name, 'REQUEST')
      );
  }
  return state;
}
